# AWS::CloudFormation::ModuleVersion generated from spec 22.0.0
...
package Cfn::Resource::Properties::AWS::CloudFormation::ModuleVersion {
  ...
  has ModuleName => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, required => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
  has ModulePackage => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
}
